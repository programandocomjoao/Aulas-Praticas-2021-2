...
const Estilos = StyleSheet.create(
    {
        ...
        titulo: {fontSize: 24, fontWeight: 'bold', marginTop: 10, textAlign: 'center'},
        paragrafo: {fontSize: 14, marginTop: 10, lineHeight: 17, textAlign: 'justify'},
        imagem: {marginTop: 20, alignSelf: 'center'}
    }
);
